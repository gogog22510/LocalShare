...
public class ReturnValueIpMessage extends Message {

	private List<String> ipList;
	public ReturnValueIpMessage(int msgid, KademliaId kid) {
		super(msgid, kid);
	...
	public void serialize(OutputStream out) throws IOException {
		KademliaUtil.writeMessageHeader(out, MsgType.RETURN_VALUE_IP.cmd(), kid.getBytes(), msgid, to);
	...
	public static ReturnValueIpMessage parseFrom(byte[] buf, int length) throws IOException {
		int msgid = KademliaUtil.getMsgIDFromMessage(buf);
		KademliaId kid = KademliaUtil.getKademliaIdFromMessage(buf);
		ReturnValueIpMessage msg = new ReturnValueIpMessage(msgid, kid);
	...
	public static void main(String[] args) throws IOException {
		...
		ReturnValueIpMessage msg = new ReturnValueIpMessage(87, kid);
		...
		ReturnValueIpMessage r = (ReturnValueIpMessage) MessageCracker.crack(data, data.length);
